describe("Basic user flow for Website", () => {
    ...
    it("Make sure <product-item> elements are populated", async () => {
        ...
        for (let i = 0; i < 20; i++) {
            console.log(
                `Checking product item ${i + 1}/${prodItemsData.length}`
            );
    ...
    */
    ...
    it('Clicking the "Add to Cart" button should change button text', async () => {
        ...
        await button.click();
        let clickedText = await button.getProperty("innerText");
        clickedText = clickedText.jsonValue();
     ...
     */
        ...
        expect(rememberedItems).toBe(true);
    }, 10000);
